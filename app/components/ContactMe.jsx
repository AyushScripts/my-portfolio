...
const ContactMe = () => {
  return (
    <div className='flex flex-col gap-5 py-5 mt-20 text-center'>
        ...
        <a className='text-base md:text-lg mx-auto text-white dark:text-[black] font-semibold bg-purple-400/90 hover:bg-purple-400 transition-all ease-in px-4 py-3 mt-4 rounded-lg' href="mailto:ayushtheking117@gmail.com">Shoot Me a Message!</a>
